...
//         {
//             IntPtr fn = IntPtr.Zero;// Marshal.GetFunctionPointerForDelegate(lua_errorReport);
//             return lua_pcallk(luaState, nArgs, nResults, errfunc, 0, fn);
//        
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
...
//        }
        ...
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern int luaS_newudata(IntPtr luaState, int val);
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
