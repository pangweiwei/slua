...
public class Lua_UnityEngine_Physics2D : LuaObject {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,get_raycastsStartInColliders, "get_raycastsStartInColliders");
		addMember(l,set_raycastsStartInColliders, "set_raycastsStartInColliders");
		addMember(l,get_changeStopsCallbacks, "get_changeStopsCallbacks");
		addMember(l,set_changeStopsCallbacks, "set_changeStopsCallbacks");
