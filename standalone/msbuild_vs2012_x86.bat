...
%MSBUILD% %PROJECT% /property:Configuration="Release_Windows";GenerateDocumentation=true;DeployOnBuild=true;PublishProfile=Deployment' /target:Rebuild /nologo /verbosity:normal
