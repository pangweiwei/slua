...
public class Lua_UnityEngine_Renderer : LuaObject {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,Render);
		addMember(l,"isPartOfStaticBatch",get_isPartOfStaticBatch,null);
		...
		addMember(l,"castShadows",get_castShadows,set_castShadows);
		addMember(l,"receiveShadows",get_receiveShadows,set_receiveShadows);
		addMember(l,"material",get_material,set_material);
		addMember(l,"sharedMaterial",get_sharedMaterial,set_sharedMaterial);
		addMember(l,"sharedMaterials",get_sharedMaterials,set_sharedMaterials);
		addMember(l,"materials",get_materials,set_materials);
		addMember(l,"bounds",get_bounds,null);
		addMember(l,"lightmapIndex",get_lightmapIndex,set_lightmapIndex);
		addMember(l,"lightmapTilingOffset",get_lightmapTilingOffset,set_lightmapTilingOffset);
		addMember(l,"isVisible",get_isVisible,null);
		addMember(l,"useLightProbes",get_useLightProbes,set_useLightProbes);
		addMember(l,"lightProbeAnchor",get_lightProbeAnchor,set_lightProbeAnchor);
