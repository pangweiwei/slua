...
public class Lua_UnityEngine_Rigidbody2D : LuaObject {
	...
	static public int MovePosition(IntPtr l) {
		try{
			UnityEngine.Rigidbody2D self=checkSelf<UnityEngine.Rigidbody2D>(l);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,GetRelativePoint, "GetRelativePoint");
		addMember(l,GetVector, "GetVector");
		addMember(l,GetRelativeVector, "GetRelativeVector");
		...
		addMember(l,get_gravityScale, "get_gravityScale");
		addMember(l,set_gravityScale, "set_gravityScale");
		addMember(l,get_isKinematic, "get_isKinematic");
		addMember(l,set_isKinematic, "set_isKinematic");
		addMember(l,get_fixedAngle, "get_fixedAngle");
		addMember(l,set_fixedAngle, "set_fixedAngle");
		addMember(l,get_simulated, "get_simulated");
		addMember(l,set_simulated, "set_simulated");
		addMember(l,get_interpolation, "get_interpolation");
		addMember(l,set_interpolation, "set_interpolation");
		addMember(l,get_sleepMode, "get_sleepMode");
		addMember(l,set_sleepMode, "set_sleepMode");
		...
		createTypeMetatable(l, typeof(UnityEngine.Rigidbody2D),typeof(UnityEngine.Component));
		LuaDLL.lua_pop(l, 1);
	}
}
