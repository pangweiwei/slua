...
public class Lua_UnityEngine_GL : LuaObject {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,Vertex3, "Vertex3");
		addMember(l,Vertex, "Vertex");
		addMember(l,Color, "Color");
		addMember(l,TexCoord, "TexCoord");
		addMember(l,TexCoord2, "TexCoord2");
		addMember(l,TexCoord3, "TexCoord3");
		addMember(l,MultiTexCoord2, "MultiTexCoord2");
		addMember(l,MultiTexCoord3, "MultiTexCoord3");
		addMember(l,MultiTexCoord, "MultiTexCoord");
		addMember(l,Begin, "Begin");
		addMember(l,End, "End");
		addMember(l,LoadOrtho, "LoadOrtho");
		addMember(l,LoadPixelMatrix, "LoadPixelMatrix");
		addMember(l,Viewport, "Viewport");
		addMember(l,LoadProjectionMatrix, "LoadProjectionMatrix");
		addMember(l,LoadIdentity, "LoadIdentity");
		addMember(l,MultMatrix, "MultMatrix");
		addMember(l,PushMatrix, "PushMatrix");
		addMember(l,PopMatrix, "PopMatrix");
		addMember(l,GetGPUProjectionMatrix, "GetGPUProjectionMatrix");
		addMember(l,SetRevertBackfacing, "SetRevertBackfacing");
		addMember(l,Clear, "Clear");
		addMember(l,ClearWithSkybox, "ClearWithSkybox");
		addMember(l,InvalidateState, "InvalidateState");
		addMember(l,IssuePluginEvent, "IssuePluginEvent");
		addMember(l,get_TRIANGLES, "get_TRIANGLES");
		addMember(l,get_TRIANGLE_STRIP, "get_TRIANGLE_STRIP");
		addMember(l,get_QUADS, "get_QUADS");
		addMember(l,get_LINES, "get_LINES");
		addMember(l,get_modelview, "get_modelview");
		addMember(l,set_modelview, "set_modelview");
		addMember(l,get_wireframe, "get_wireframe");
		addMember(l,set_wireframe, "set_wireframe");
		addMember(l,get_sRGBWrite, "get_sRGBWrite");
		addMember(l,set_sRGBWrite, "set_sRGBWrite");
		newType(l, constructor);
		createTypeMetatable(l, typeof(UnityEngine.GL));
		LuaDLL.lua_pop(l, 1);
	}
}
